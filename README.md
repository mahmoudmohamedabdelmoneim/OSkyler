...
Set the client ID properly. For example `Outlook:Mailbox` and `Dashboard:Mailbox` must identify the same account or the dashboard query will not find the imported work.
